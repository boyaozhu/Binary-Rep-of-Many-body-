...
# indexing of basis
def construct_index(particles, Nstates, Slater, basis, M_scheme):
  
  states, M = basis(particles, Nstates, Slater)
...
def main():
  ...
  index = construct_index(particles, Nstates, Slater, basis, M_scheme)
